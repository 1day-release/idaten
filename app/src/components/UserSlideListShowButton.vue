<template>
  <div class="user-slide-list-show"  v-bind:class="{isActive}" @click.stop="showUserSlideList() ">
  ...
  .user-slide-list-show {
    ...
    #app.is_logout & {
      ...
      &::after {
        ...
        margin: auto;
        display: block;
        background-color: rgba( map-get($color-brand, "black"), 0.3 );
      }
